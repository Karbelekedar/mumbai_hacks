...
const Signin = () => {
  ...
  return (
    <div className="h-screen">
      <div className="h-full flex justify-center items-center bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
        <div className="flex flex-wrap items-center">
          <div className="w-full xl:w-1/2">
            <div className="w-full p-4 border-r border-black sm:p-12.5 xl:p-15">
              <div>
                <form>
                  <div className="mb-4">
                    <label
          ...
          <div className="hidden w-full p-7.5 xl:block xl:w-1/2">
            <div className="custom-gradient-1 overflow-hidden px-12.5 pb-16 dark:!bg-dark-2 dark:bg-none">
              <Link
                className="mb-4 text-4xl font-bold text-dark dark:text-white sm:text-heading-3 inline-block"
                href="/"
              >
                <h1>Logo</h1>
              </Link>
