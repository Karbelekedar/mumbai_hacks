              ...
              <div>
                <form>
                  <div className="mb-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        name="name"
                        className="w-full rounded-lg border border-stroke bg-transparent py-[10px] pl-6 pr-11 font-medium text-dark outline-none focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                      />
                  ...
                  <div className="mb-2">
                    <button
                      type="submit"
                      className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg bg-primary py-2 px-4 font-medium text-white transition hover:bg-opacity-90"
                    >
                      Sign Up
                    </button>
                  </div>
          ...
          <div className="hidden w-full p-7.5 xl:block xl:w-1/2">
            <div className="custom-gradient-1 overflow-hidden px-12.5 pb-16 dark:!bg-dark-2 dark:bg-none">
              ...
              <p className="w-full max-w-[375px] font-medium text-dark-4 dark:text-dark-6">
                You can create your account by completing the necessary fields
                below
              </p>
            </div>
          </div>
